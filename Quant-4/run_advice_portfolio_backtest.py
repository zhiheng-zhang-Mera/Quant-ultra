...
def main() -> int:
    ...
    parser.add_argument("--minimum-market-coverage", type=int, default=50, help="Fail closed unless this many real histories are available")
    parser.add_argument("--minimum-stock-coverage", type=int, default=100, help="ETF histories cannot substitute for broad stock coverage")
    ...
    parser.add_argument("--source-cooldown-seconds", type=float, default=60.0)
    ...
    if not args.cache_only:
        ...
        refresh_audit = refresh_full_market_cache(args.cache_dir, str(start.date()), str(end.date()), args.download_workers, prefixes, args.minimum_market_coverage, args.minimum_stock_coverage, args.source_timeout_seconds, args.source_cooldown_seconds)
