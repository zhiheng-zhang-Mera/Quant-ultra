...
## **On hold** to add logic:
    - Simplify logger -> dual language into 1 line logger, less debugging purpose loggers
    - some logger error message from compilor need attention, check phase result
    - Check data download truth (ensuring not using mock data or data not matching by date)
